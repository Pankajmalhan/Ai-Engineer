"""The 'Q1 pipeline' this week evaluates: a minimal retrieve-then-generate RAG
pipeline over app/corpus.py, standalone from prior weeks' projects. Retrieval is BM25
(no API cost); generation calls OpenAI and needs OPENAI_API_KEY (app/llm.py).
"""
