...
fixture as Weeks 5-7, kept as its own copy since each week's project is a standalone
deliverable (own pyproject.toml/venv, no cross-week imports). No red-team fixtures this
week (no poisoned/internal-only documents) -- this week's target is quality/observability
in production, not adversarial robustness.
"""
