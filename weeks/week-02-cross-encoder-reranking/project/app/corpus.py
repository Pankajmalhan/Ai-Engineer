"""Synthetic benchmark corpus + query set, carried over verbatim from Week 1
(../../week-01-hybrid-search-rrf/project/app/corpus.py) so Week 2's reranking
A/B test measures a lift over the *same* hybrid pipeline and benchmark
queries Week 1 measured recall@10 on, not a different corpus. Do not edit
this file without also updating Week 1's copy -- they're expected to stay
identical.
